...
UI tests cover explicit source/translation text, preserved line breaks, escaped markup, adjacent cues, unavailable candidates, disabled actions, stale evidence, keyboard approval, announced results and responsive layout. New comparison snapshots were inspected visually. The two mobile Manual Review baselines were updated for the revised page description/footer; unrelated baselines continued to pass.
