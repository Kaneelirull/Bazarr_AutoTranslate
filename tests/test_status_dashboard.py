...
class StatusDashboardTests(unittest.TestCase):
    ...
    def test_dashboard_assets_render_timing_and_protection_states(self):
        ...
        self.assertIn("healthy ${remaining === 1 ? \"cycle\" : \"cycles\"} remaining", script)
        ...
        self.assertIn('class="retry-details"', script)
        self.assertIn("<summary>View details</summary>", script)
        self.assertIn('"Regeneration waiting"', script)
        self.assertIn('"Regeneration queued"', script)
        self.assertIn('"Retry in progress"', script)
        ...
        self.assertIn('return "Now"', script)
        ...
        self.assertIn(".retry-details summary:focus-visible", stylesheet)
