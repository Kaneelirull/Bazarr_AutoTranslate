...
import { labelForState, numberValue, operationLabel } from "./format";
...
export function Diagnostics({ timing = {}, circuits = [] }: { timing?: DataRow; circuits?: DataRow[] }) {
  ...
  return <section className="health-section" aria-labelledby="timing-protection-title"><div className="subsection-header"><h3 id="timing-protection-title">Timing & protection</h3><p className="section-note">Adaptive estimates and series circuit-breaker status.</p></div>
...
export function RecoveryDiagnostics({ diagnostics = {} }: { diagnostics?: DataRow }) {
  ...
  return <section className="health-section" aria-labelledby="recovery-reliability-title"><div className="subsection-header"><h3 id="recovery-reliability-title">Recovery reliability</h3><p className="section-note">{note}</p></div>
...
export function LatestMaintenance({ maintenance = {} }: { maintenance?: DataRow }) {
  ...
  return <section className="health-section" aria-labelledby="latest-maintenance-title"><div className="subsection-header"><h3 id="latest-maintenance-title">Latest maintenance scan</h3><p className="section-note">{lastScan?.timestamp ? `Scanned ${relativeTime(lastScan.timestamp)}` : "No scan recorded"}</p></div>
